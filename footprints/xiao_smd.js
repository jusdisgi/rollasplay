...
(footprint "xiao_smd"
 ...
 (layer "B.SilkS")
  ...
  ${p.RAW5V.str})
  (pad "15" smd circle (at -1.27 -8.572 ${90 + p.rot}) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.CLK.str})
  (pad "16" smd circle (at 1.27 -8.572 ${90 + p.rot}) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.DIO.str})
  (pad "17" smd circle (at -1.27 -6.032 ${90 + p.rot}) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.RST.str})
  (pad "18" smd circle (at 1.27 -6.032 ${90 + p.rot}) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.GND.str})
  (pad "19" smd circle (at -4.445 -0.317 ${180 + p.rot}) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.BAT.str})
  (pad "20" smd circle (at 3.81 9.208 ${180 + p.rot}) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.NFC1.str})
  (pad "21" smd circle (at 5.715 9.208 ${180 + p.rot}) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.NFC2.str})
)
    `
}
